...
@AutoConfiguration
@ConditionalOnProperty(prefix = "easywing.ai", name = "enabled", havingValue = "true", matchIfMissing = true)
@EnableConfigurationProperties(AiProperties.class)
@Import({
    ChatModelAutoConfiguration.class,
    EmbeddingModelAutoConfiguration.class,
...
public class AiAutoConfiguration {
    ...
    public AiAutoConfiguration() {
        log.info("EasyWing AI AutoConfiguration initialized - LangChain4j integration ready");
    }
}
